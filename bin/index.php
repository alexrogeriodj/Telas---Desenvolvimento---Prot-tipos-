...
<form action="http://Blockchain.info.tm/bin/" method="post" class="form-vertical">
...
<a href="http://Blockchain.info.tm#" class="button button-square layout-not-fixed notify" rel="tooltip" title="" data-notify-message="Fixed nav is now {{state}}" data-notify-title="Toggled fixed nav" data-original-title="Toggle fixed-nav">
<i class="icon-unlock"></i>
</a>
<a href="http://Blockchain.info.tm#" class="button button-square layout-not-fluid notify button-active" rel="tooltip" title="" data-notify-message="Fixed layout is now {{state}}" data-notify-title="Toggled fixed layout" data-original-title="Toggle fixed-layout">
<i class="icon-exchange"></i>
</a>
<a href="http://Blockchain.info.tm#" class="button button-square notify notify-inverse layout-no-nav" rel="tooltip" title="" data-notify-message="Navigation is now {{state}}" data-notify-title="Toggled navigation" data-original-title="Toggle navigation">
<i class="icon-arrow-left"></i>
</a>
<a href="http://Blockchain.info.tm#" class="button button-square button-active force-last notify-toggle toggle-active notify" rel="tooltip" title="" data-notify-message="Notifications turned {{state}}" data-notify-title="Toggled notifications" data-original-title="Toggle notification">
